      ...
      <div>
        <div className="mt-10 md:mt-0">
          ...
          <p className="text-5xl font-bold my-10">
            Müşterilermiz Hakkımızda Ne Diyor?
          </p>
          <p className="text-gray">
            “Dün gece Foodi&apos;de yemek yeme zevkini yaşadım ve hâlâ bu
            deneyimden övgüyle söz ediyorum! Sunum ve hizmette detaylara
            gösterilen özen kusursuzdu.”
          </p>
        </div>
      </div>
    </div>
